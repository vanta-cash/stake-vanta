...
import { Wallet, Lock, Clock, Zap, ChevronDown, ChevronUp, Info, AlertCircle, Trophy } from "lucide-react"
...
export default function StakePage() {
  ...
  return (
    <main className="min-h-screen bg-black text-white custom-cursor pt-20 pb-16">
                      ...
                      <div className="bg-muted-darker p-4 rounded-lg border border-primary-cyan/20 mb-4">
                        ...
                        <div className="space-y-1 sm:space-y-2 mt-4">
                          <Label className="flex items-center">
                            <Clock className="mr-1 h-3 w-3 text-primary-cyan" />
                            Staking Period
                          </Label>
